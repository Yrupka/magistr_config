...
public class Options_lab_2 : MonoBehaviour
{
    ...
    private Graph_shower_lab_2 graph;
    ...
    private void Awake() // нахождение всех полей
    {
        ...
        transform.Find("Graph_update").GetComponent<Button>().onClick.AddListener(() => Graph_update(3));
        ...
        graph = transform.Find("Graph").GetComponent<Graph_shower_lab_2>();
    ...
    {
        Engine_options_lab_2 graph_options = new Engine_options_lab_2("", "");
    ...
    IEnumerator Save_dialog()
    {
        ...
        if (FileBrowser.Success)
            File_controller.Save_table(table.GetItems(), FileBrowser.Result[0], 2);
    }
