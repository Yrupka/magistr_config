...
public class Engine_options_lab_3
{
    ...
    public struct struct_rpms
    {
        ...
        public struct_rpms(int rpm, float moment, float consumption, float air)
        {
            this.rpm = rpm;
            this.moment = moment;
    ...
    public Engine_options_lab_3(string engine, string car)
    {
        engine_name = engine;
        car_name = car;
        hints = new string[4];
    ...
    {
        string[,] converted_rpms = new string[rpms.Count, 4];
        int i = 0;
        foreach (struct_rpms rpm in rpms)
        {
            ...
            converted_rpms[i, 3] = rpm.air.ToString();
            i++;
        }
